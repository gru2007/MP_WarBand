...
force ace_medical_fatalDamageSource = 0.5;
...
force ace_medical_ivFlowRate = 2.25;
ace_medical_limping = 1;
force ace_medical_painCoefficient = 2.25;
...
// ACE ПНВ
force ace_nightvision_aimDownSightsBlur = 2;
force ace_nightvision_disableNVGsWithSights = false;
force ace_nightvision_effectScaling = 2;
force ace_nightvision_fogScaling = 2;
force ace_nightvision_noiseScaling = 2;
...
// ACE Перегрузки
force ace_gforces_coef = 0.63727;
...
Achilles_var_CSA38_CIV = true;
Achilles_var_fow_aus = true;
Achilles_var_fow_heer = true;
Achilles_var_fow_hi = true;
Achilles_var_fow_ija = true;
Achilles_var_fow_ija_nas = true;
Achilles_var_fow_it = true;
Achilles_var_fow_luftwaffe = true;
Achilles_var_fow_uk = true;
Achilles_var_fow_uk_faa = true;
Achilles_var_fow_uk_raf = true;
Achilles_var_fow_usa = true;
Achilles_var_fow_usa_navy = true;
Achilles_var_fow_usa_p = true;
Achilles_var_fow_usmc = true;
Achilles_var_fow_waffenss = true;
Achilles_var_fow_wehrmacht = true;
Achilles_var_GEIST1ArmiaWojskaPolskiego = true;
Achilles_var_GEISTAlle = true;
Achilles_var_GEISTArmeeBlindeeFr = true;
Achilles_var_GEISTArmeeFinlandaise = true;
Achilles_var_GEISTArmeeFr = true;
Achilles_var_GEISTArmiaKrajowa = true;
Achilles_var_GEISTBrArmy = true;
Achilles_var_GEISTCivils = true;
Achilles_var_GEISTHeer = true;
Achilles_var_GEISTKazaki = true;
Achilles_var_GEISTLotnictwoWojskaPolskiego = true;
Achilles_var_GEISTLuftwaffe = true;
Achilles_var_GEISTMiliceFrancaise = true;
Achilles_var_GEISTNKVD = true;
Achilles_var_GEISTPanzerAufklarung = true;
Achilles_var_GEISTPanzerwaffe = true;
Achilles_var_GEISTPartizany = true;
Achilles_var_GEISTRedArmy = true;
Achilles_var_GEISTRedArmyCavalry = true;
Achilles_var_GEISTRedArmyTankTroops = true;
Achilles_var_GEISTResistance = true;
Achilles_var_GEISTROA = true;
Achilles_var_GEISTSS = true;
Achilles_var_GEISTSturmartillerie = true;
Achilles_var_GEISTUSAF = true;
Achilles_var_GEISTUSArmored = true;
Achilles_var_GEISTUSArmy = true;
Achilles_var_GEISTVDV = true;
Achilles_var_GEISTVVS = true;
Achilles_var_GEISTWaffenSS = true;
Achilles_var_GEISTWehrmacht = true;
Achilles_var_IFA3_COLLABOR = true;
...
Achilles_var_LIB_ACI = true;
Achilles_var_LIB_ARR = true;
Achilles_var_LIB_CIV = true;
Achilles_var_LIB_DAK = true;
Achilles_var_LIB_FFI = true;
Achilles_var_LIB_FSJ = true;
Achilles_var_LIB_GUER = true;
Achilles_var_LIB_LUFTWAFFE = true;
Achilles_var_LIB_LUFTWAFFE_w = true;
Achilles_var_LIB_MKHL = true;
Achilles_var_LIB_NAC = true;
Achilles_var_LIB_NKVD = true;
Achilles_var_LIB_PANZERWAFFE = true;
Achilles_var_LIB_PANZERWAFFE_w = true;
Achilles_var_LIB_RAAF = true;
Achilles_var_LIB_RAF = true;
Achilles_var_LIB_RBAF = true;
Achilles_var_LIB_RKKA = true;
Achilles_var_LIB_RKKA_w = true;
Achilles_var_LIB_SD_ATTACKERS = true;
Achilles_var_LIB_SD_DEFENDERS = true;
Achilles_var_LIB_SD_SystemUnits = true;
Achilles_var_LIB_UK_AB = true;
Achilles_var_LIB_UK_AB_w = true;
Achilles_var_LIB_UK_ARMY = true;
Achilles_var_LIB_UK_ARMY_w = true;
Achilles_var_LIB_UK_DR = true;
Achilles_var_LIB_US_101AB = true;
Achilles_var_LIB_US_82AB = true;
Achilles_var_LIB_US_AIRFORCE = true;
Achilles_var_LIB_US_AIRFORCE_w = true;
Achilles_var_LIB_US_ARMY = true;
Achilles_var_LIB_US_ARMY_w = true;
Achilles_var_LIB_US_RANGERS = true;
Achilles_var_LIB_US_TANK_TROOPS = true;
Achilles_var_LIB_US_TANK_TROOPS_w = true;
Achilles_var_LIB_USSR_AIRFORCE = true;
Achilles_var_LIB_USSR_AIRFORCE_w = true;
Achilles_var_LIB_USSR_TANK_TROOPS = true;
Achilles_var_LIB_USSR_TANK_TROOPS_w = true;
Achilles_var_LIB_WEHRMACHT = true;
Achilles_var_LIB_WEHRMACHT_w = true;
Achilles_var_NORTH_FIN = true;
Achilles_var_NORTH_FIN_S = true;
Achilles_var_NORTH_FIN_W_39 = true;
Achilles_var_NORTH_NOR = true;
Achilles_var_NORTH_SOV = true;
Achilles_var_NORTH_SOV_W_39 = true;
...
Achilles_var_sab_fl_faction_blue = true;
Achilles_var_sab_fl_faction_green = true;
Achilles_var_sab_fl_faction_red = true;
Achilles_var_SG_STURM = true;
Achilles_var_SG_STURM_w = true;
Achilles_var_SG_STURMPANZER = true;
Achilles_var_Simc_MC_50 = true;
Achilles_var_Simc_MC_53 = true;
Achilles_var_Simc_UA_43 = true;
Achilles_var_Simc_UA_44 = true;
Achilles_var_Simc_UA_50 = true;
Achilles_var_Simc_UA_53 = true;
Achilles_var_Simc_UA_ETO = true;
Achilles_var_Simc_UA_ETO_w = true;
Achilles_var_Simc_UAAB_generic = true;
Achilles_var_Simc_US_101AB = true;
Achilles_var_Simc_US_101AB_Late = true;
Achilles_var_Simc_US_17AB = true;
Achilles_var_Simc_US_82AB = true;
Achilles_var_Simc_US_82AB_Early = true;
Achilles_var_Simc_US_82AB_Late = true;
Achilles_var_Simc_USMC = true;
Achilles_var_Simc_USN = true;
...
// IFA3 Liberation
ifa3_plane_Script_cba_eng = true;
ifa3_plane_Script_cba_fuel = true;
ifa3_plane_Script_cba_start = false;
ifa3_screams_cba_death = true;
ifa3_screams_cba_hit_blue = true;
ifa3_screams_cba_hit_green = true;
ifa3_screams_cba_hit_red = true;
ifa3_tank_Script_cba_ammo = true;
ifa3_tank_Script_cba_fire_car = true;
ifa3_tank_Script_cba_start = false;
ifa3lib_compass_init = true;
ifa3lib_damage_cba_kontuzia_gr = true;
ifa3lib_damage_cba_kontuzia_ofc = true;
ifa3lib_tank_cba_crew_ai = true;
ifa3lib_tank_cba_crew_player = true;
ifa3lib_tank_cba_engine = true;
ifa3lib_tank_cba_fuel = true;
ifa3lib_tank_cba_radio = true;
ifa3lib_tank_cba_trans = true;
...
zen_faction_filter_0_CSA38_RU = true;
zen_faction_filter_0_EdCat_NORTH_SOV_Army = true;
zen_faction_filter_0_EdCat_NORTH_SOV_Army_41 = true;
zen_faction_filter_0_EdCat_NORTH_SOV_ArmyW = true;
zen_faction_filter_0_EdCat_NORTH_SOV_ArmyW_39 = true;
zen_faction_filter_0_EdCat_NORTH_SOV_ArmyW_41 = true;
zen_faction_filter_0_GEIST1ArmiaWojskaPolskiego = true;
zen_faction_filter_0_GEISTNKVD = true;
zen_faction_filter_0_GEISTPartizany = true;
zen_faction_filter_0_GEISTRedArmy = true;
zen_faction_filter_0_GEISTRedArmyTankTroops = true;
zen_faction_filter_0_GEISTVDV = true;
zen_faction_filter_0_GEISTVVS = true;
...
zen_faction_filter_0_NORTH_SOV_W = true;
zen_faction_filter_0_NORTH_SOV_W_39 = true;
zen_faction_filter_0_NORTH_SOV_W_41 = true;
...
zen_faction_filter_0_sab_fl_faction_red = true;
...
zen_faction_filter_1_CSA38_GERM = true;
zen_faction_filter_1_CSA38_GERM_DE = true;
zen_faction_filter_1_CSA38_GERM_FR = true;
zen_faction_filter_1_CSA38_GERM_LATE = true;
zen_faction_filter_1_CSA38_GERM_PL = true;
zen_faction_filter_1_CSA38_GERM_W = true;
zen_faction_filter_1_CSA38_GERMGROUPS = true;
zen_faction_filter_1_CSA38_GERMGROUPS40 = true;
zen_faction_filter_1_CSA38_SFK = true;
zen_faction_filter_1_CSA38_SS = true;
zen_faction_filter_1_CSA38_SS40 = true;
...
zen_faction_filter_1_GEISTArmeeFinlandaise = true;
zen_faction_filter_1_GEISTHeer = true;
zen_faction_filter_1_GEISTKazaki = true;
zen_faction_filter_1_GEISTLuftwaffe = true;
zen_faction_filter_1_GEISTMiliceFrancaise = true;
zen_faction_filter_1_GEISTPanzerAufklarung = true;
zen_faction_filter_1_GEISTPanzerwaffe = true;
zen_faction_filter_1_GEISTROA = true;
zen_faction_filter_1_GEISTSS = true;
zen_faction_filter_1_GEISTSturmartillerie = true;
zen_faction_filter_1_GEISTWaffenSS = true;
zen_faction_filter_1_GEISTWehrmacht = true;
zen_faction_filter_1_IFA3_COLLABOR_category = true;
...
zen_faction_filter_1_sab_fl_faction_blue = true;
...
zen_faction_filter_2_CSA38_CSA38 = true;
zen_faction_filter_2_CSA38_CSOB = true;
zen_faction_filter_2_CSA38_CSSSR = true;
zen_faction_filter_2_CSA38_CZECHGROUPS = true;
zen_faction_filter_2_CSA38_FIN = true;
zen_faction_filter_2_CSA38_GB = true;
zen_faction_filter_2_CSA38_PL = true;
zen_faction_filter_2_CSA38_ROM = true;
zen_faction_filter_2_CSA38_SLOV = true;
zen_faction_filter_2_CSA38_SPOL = true;
zen_faction_filter_2_EdCat_NORTH_FIN_Army = true;
zen_faction_filter_2_EdCat_NORTH_FIN_Army_41 = true;
zen_faction_filter_2_EdCat_NORTH_FIN_ArmyS = true;
zen_faction_filter_2_EdCat_NORTH_FIN_ArmyS_41 = true;
zen_faction_filter_2_EdCat_NORTH_FIN_ArmyW = true;
zen_faction_filter_2_EdCat_NORTH_FIN_ArmyW_39 = true;
zen_faction_filter_2_EdCat_NORTH_FIN_ArmyW_41 = true;
zen_faction_filter_2_EdCat_NORTH_NOR_Army = true;
zen_faction_filter_2_EdCat_NORTH_NOR_ArmyW = true;
zen_faction_filter_2_EdCat_NORTH_NOR_Res = true;
...
zen_faction_filter_2_GEISTArmeeBlindeeFr = true;
zen_faction_filter_2_GEISTArmeeFr = true;
zen_faction_filter_2_GEISTArmiaKrajowa = true;
zen_faction_filter_2_GEISTBrArmy = true;
zen_faction_filter_2_GEISTResistance = true;
zen_faction_filter_2_GEISTUSAF = true;
zen_faction_filter_2_GEISTUSArmored = true;
zen_faction_filter_2_GEISTUSArmy = true;
...
zen_faction_filter_2_NORTH_FIN = true;
zen_faction_filter_2_NORTH_FIN_S_41 = true;
zen_faction_filter_2_NORTH_FIN_W_39 = true;
zen_faction_filter_2_NORTH_FIN_W_41 = true;
zen_faction_filter_2_NORTH_FINS = true;
zen_faction_filter_2_NORTH_FINW = true;
...
zen_faction_filter_2_sab_fl_faction_green = true;
zen_faction_filter_2_Simc_UA_44 = true;
zen_faction_filter_2_Simc_UA_ETO = true;
zen_faction_filter_2_Simc_USN = true;
zen_faction_filter_3_CIV_F = true;
zen_faction_filter_3_CIV_IDAP_F = true;
zen_faction_filter_3_CSA38_CIV = true;
zen_faction_filter_3_EdCat_NORTH_NOR_Civ = true;
